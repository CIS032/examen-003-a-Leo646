...
public class Cargar_Base {
    public Connection acceder(){
        ...
        try {
            String urlbd = "jdbc:derby://localhost:1527/cuentas bancarias ";//url para conectarnos a la base de datos utilizando la sintaxis de JDBC
